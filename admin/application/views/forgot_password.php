...
<head>
    ...
    <title>Adminca bootstrap 4 &amp; angular 5 admin template, Шаблон админки | Forgot Password</title>
...
<body>
    ...
    <div class="ibox login-content">
        ...
        <form class="ibox-body pt-0" id="forgot-form" action="javascript:;" method="POST">
            ...
            <div class="text-center">
                <button class="btn btn-primary btn-rounded btn-block btn-air">SUBMIT</button><br>
                <a class="color-inherit pull-right" href="login">Go to Login</a>
            </div>
        </form>
    </div>
