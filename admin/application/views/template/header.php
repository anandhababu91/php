<?php if(!$this->session->userdata('user_id')) redirect('login','refresh'); ?>
<!DOCTYPE html>
<html lang="en"> 
                ...
                <ul class="nav navbar-toolbar">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-media">
                            ...
                            <div class="p-3">
                                <div class="media-list media-list-divider scroller" data-height="350px" data-color="#71808f">
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo base_url(); ?>assets/img/users/u8.jpg" alt="image" />
                                        </div>
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo base_url(); ?>assets/img/users/u6.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo base_url(); ?>assets/img/users/u11.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo base_url(); ?>assets/img/users/u10.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo base_url(); ?>assets/img/users/u2.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo base_url(); ?>assets/img/users/u5.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo base_url(); ?>assets/img/users/u9.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <img src="<?php echo base_url(); ?>assets/img/users/admin-image.png" alt="image" />
                        </a>
                        <div class="dropdown-menu dropdown-arrow dropdown-menu-right admin-dropdown-menu">
                            ...
                            <div class="dropdown-header p-3">
                                ...
                                <div>
                                    <h5 class="font-strong text-white"><?php echo $this->session->userdata('firstname'); ?></h5> 
                                </div>
                            </div>
                            <div class="admin-menu-features p-2">
                                <a class="admin-features-item" href="<?php echo base_url() ?>profile"><i class="ti-user"></i>
                                    <span>PROFILE</span>
                                </a>
                               <!--  <a class="admin-features-item" href="javascript:;"><i class="ti-support"></i>
                                    <span>SUPPORT</span>
                                </a> -->
                                <a class="admin-features-item" href="<?php echo base_url() ?>login/logout"><i class="ti-shift-right"></i>
                                    <span>LOGOUT</span>
                                </a>
